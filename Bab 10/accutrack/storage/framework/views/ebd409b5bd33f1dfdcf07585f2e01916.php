    ...
    <div class="content">
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn-cetak">
                <a href="/cetak" target="_blank">Cetak Data</a>
            </button>
        </div>
        <table class="table-data">
            ...
            <tbody>
                <?php $__currentLoopData = $pendapatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <td><?php echo e($pt->rentang_tanggal); ?></td>
                <td><?php echo e($pt->kategori); ?></td>
                <td><?php echo e($pt->total); ?></td>
                <td><?php echo e($pt->keterangan); ?></td>
                <td><div class="btn-group">
            <button type="button" class="btn-edit">
                <a href="edit/<?php echo e($pt->id); ?>">Edit</a>
                <div class="btn-group">
            <button type="button" class="btn-hapus">
                <a href="/destroy/<?php echo e($pt->id); ?>">Hapus</a>
            </td>
...
<?php /**PATH C:\Kuliah S1\Semester 3\Praktikum\PEMWEB\TUGAS\Bab 10\accutrack\resources\views/kelola/index.blade.php ENDPATH**/ ?>